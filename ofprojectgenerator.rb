class Ofprojectgenerator < Formula
    ...
    homepage "https://github.com/thomasgeissl/ofProjectGenerator"
    url "https://github.com/thomasgeissl/ofProjectGenerator/releases/download/#{version}/commandline_osx_#{version}.zip"
